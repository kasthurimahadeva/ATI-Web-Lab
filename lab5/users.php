 ...
 //  echo "Id: $id, First Name: $firstname, Last Name: $lastname, Email: $email, Address:$address, Age:$age";
    ...
    foreach ($users as $user) {  
           ...
           echo 
            ...
            "<table style='width:350px; background-color:#6666FF'  align='center' border: 1px solid black; border color:#0000FF;}>
            ...
            <tr>
                <th align='center' colspan='6'><img src='ava.png'  width='100' height='120'></th>
